  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        // quote bloc
        BlocProvider(
          create: (context) => locator.get<QuoteBloc>()..add(UpdateQuote()),
        ),
      ],
        ...
        child: SafeArea(
          child: Scaffold(
                              ...
                              showDialog(
                                ...
                                builder: (context) {
                                  return CustomAlertDialog(
                                    ...
                                    alertIcon:
                                        Assets.icon.svg.languagePreference,
                                    onCancelTap: () {
                                    ...
                                    cancelText:
                                        appLocalization.cancelDialogText,
                                    confirmText:
            ...
            appBar: AppBar(
              ...
              // title
              title: Text(
                appLocalization.languagePreferenceSettingsAppBarTitle,
              ),
              // title style

...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get onBoardingTitleFirst => 'ابقَ منظمًا وزد إنتاجيتك';

  @override
  String get onBoardingSubTitleFirst => 'قم بإدارة مهامك بسهولة، وتعاون مع فريقك، وتابع التقدم في مكان واحد. بفضل الجدولة الذكية، والمساعدة المدعومة بالذكاء الاصطناعي، والتحديثات الفورية، يساعدك Tasify على البقاء متقدمًا على المواعيد النهائية وتحقيق المزيد! 🚀';

  @override
  String get onBoardingTitleSecond => 'نظم، خطط وحقق';
  ...
  @override
  String get documentNotFound => 'المستند غير موجود';

  @override
  String get serviceUnavailable => 'الخدمة غير متوفرة';

  @override
  String get addTaskToastSuccess => 'تمت إضافة المهمة بنجاح';
